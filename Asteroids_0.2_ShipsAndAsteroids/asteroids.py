...
class Asteroids( Game ):
    ...
    def __init__(self, name, width, height):
        ...
        self.asteroids=[Asteroid(),Asteroid(),Asteroid(),Asteroid(),Asteroid(),Asteroid(),Asteroid()]
    ...
    def handle_input(self):
        ...
        if keys_pressed[K_UP] and self.ship:
            self.ship.accelerate(0.0025)
        if keys_pressed[K_DOWN] and self.ship:
            # self.ship.accelerate(0) #TODO: Remove comment to stop the ship instantly with down-key AKA EASYMODE.
            pass
