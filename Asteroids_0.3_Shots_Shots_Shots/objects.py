...
class Asteroid (Polygon):
    def __init__(self):
        self.points = random.choice([[Point(10,30), Point(25,25), Point(33,11), Point(35,-7), Point(21,-13),
        ...
        #[Point(10,30), Point(25,25), Point(33,11), Point(35,-7), Point(21,-13, Point(13,-29), Point(-13,-31), Point(-21,-28), Point(-28,-22), Point(-34,-6), Point(-32,14), Point(-29,21), Point(-15,9), Point(-23,24), Point(-10,30)]
        #[Point(0,10), Point(10,15), Point(18,9), Point(13,3), Point(17,-5), Point(5,-12), Point(-10,-12), Point(-16,-7), Point(-16,8), Point(-9,14)]
